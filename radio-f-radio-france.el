;;; radio-f-radio-france.el --- Radio France carrier for Radio F -*- lexical-binding: t; -*-
...
;;; Commentary:
;;
;; Radio France carrier for Radio F.
;; 79 stations.
...
(defconst radio-f--radio-france-stations
  '((fip ;; Fip runs programs that aren't recognized in the new_apprf_fip endpoint.
     :name "FIP" :id "7"
     :endpoint "new_apprf_fip" :tag "fip"
     :www "fip" :www-suffix "titres-diffuses"
     :mp3-prefix "direct"
     :mp3-domain "radiofrance"
     :carrier radio-france :metadata inter
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/fip.png")
    (franceinter
     ...
     :carrier radio-france :metadata info
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/france-inter.png")
    (franceinfo
     ...
     :carrier radio-france :metadata info
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/france-info.png")
    (francemusique
     ...
     :carrier radio-france :metadata inter
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/france-musique.png")
    (franceculture
     ...
     :carrier radio-france :metadata inter
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/france-culture.png")
    (mouv
     :name "Mouv'" :id "6"
     ...
     :carrier radio-france :metadata inter
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/mouv.png")
    (fiprock
     :name "FIP Rock" :id "64"
    ...
    (rcfm ;; Corsica.  You just know Napoleon would never have used vi.
     ...
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-rcfm.png")
    (alsace
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-alsace.png")
    (armorique
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-amorique.png")
    (auxerre
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-auxerre.png")
    (bearn
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-bearn.png")
    (belfort
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-belfort-montbeliard.png")
    (berry
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-berry.png")
    (besancon
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-besancon.png")
    (bourgogne
     :name "ici Bourgogne" :id "19"
     :endpoint "new_apprf_bleu" :tag "fbbourgogne"
     :www "francebleu" :www-suffix nil
     :mp3-prefix "direct" :mp3-domain "francebleu"
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-bourgogne.png")
    (breizh
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-breizh-izel.png")
    (champagne
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-champagne.png")
    (cotentin
     :name "ici Cotentin" :id "22"
     :endpoint "new_apprf_bleu" :tag "fbcotentin"
     :www "francebleu" :www-suffix nil
     :mp3-prefix "direct" :mp3-domain "francebleu"
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-cotentin.png")
    (creuse
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-creuse.png")
    (drome
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-drome.png")
    (gardlozere
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-gard-lozere.png")
    (gascogne
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-gascogne.png")
    (gironde
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-gironde.png")
    (herault
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-herault.png")
    (isere
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-isere.png")
    (larochelle
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-la-rochelle.png")
    (limousin
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-limousin.png")
    (loireocean
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-loire-ocean.png")
    (southlorraine
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-sud-lorraine.png")
    (mayenne
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-mayenne.png")
    (north
     :name "ici Nord" :id "36"
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-nord.png")
    (lowernormandy
     :name "ici Normandie (Calvados - Orne)" :id "37"
     :endpoint "new_apprf_bleu" :tag "fbbassenormandie"
     :www "francebleu":www-suffix nil
     :mp3-prefix "direct" :mp3-domain "francebleu"
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-normandie.png")
    (uppernormandy
    ...
    (regionauvergne
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-pays-dauvergne.png")
    (regionbasque
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-pays-basque.png")
    (regiondesavoie
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-pays-de-savoie.png")
    (perigord
    ...
    (picardie
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-picardie.png")
    (provence
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-provence.png")
    (roussillon
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-roussillon.png")
    (touraine
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-touraine.png")
    (vaucluse
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-vaucluse.png")
    (azur
     :name "ici Azur" :id "49"
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-azur.png")
    (northlorraine
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-lorraine.png")
    (poitou
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-poitou.png")
    (paris
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-paris-ile-de-france.png")
    (elsass ;; Elsass is a web-only version of Alsace.
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-elsass.png")
    (maine
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-maine.png")
    (toulouse
     :name "ici Occitanie" :id "92"
     :endpoint "new_apprf_bleu" :tag "fbtoulouse"
     :www "francebleu" :www-suffix nil
     :mp3-prefix "direct" :mp3-domain "francebleu"
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
    ...
    (saintetienne
     ...
     :carrier radio-france :metadata ici
     :processor radio-f--radio-france-processor
     :visual "assets/radio-france/ici-saint-etienne-loire.png")
    (fmceasy
    ...
    (fmpianozen
     ...
     :visual "assets/radio-france/france-musique.png")
    (fmclove
     :name "France Musique Classique Love" :carrier radio-france :id "411"
    ...
    (intermusic
     ...
     :visual "assets/radio-france/france-inter.png")
    (interkids
     :name "Mon petit France Inter" :carrier radio-france :id "1102"
...
(defun radio-f--radio-france-processor (data station)
  ...
  (let* ((now (cdr (assoc "now" data)))
    ...
    (unless (radio-f--ordures-p now)
      ...
      ;; Do the exceptions.
      (cond
       ((memq metadata '(inter ici fip))
        (setq-local visual-url
                    (format
